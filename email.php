...
$voltar   = "<script>setTimeout(function(){window.location.href=\"Formulario.php\";},5000);</script>";
$erro     = false;
...
if ( $erro ) {
    ...
    define('GUSER', 'exemplo0@gmail.com');    // <-- Insira aqui o seu GMail
    define('GPWD', 'sasas213wsq');                        // <-- Insira aqui a senha do seu GMail
